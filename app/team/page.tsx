...
const css = `
  .team-page{min-height:100vh;background:#07101a;color:#fff;--gold:#ef4a50;--gold-light:#ef4a50;--panel:#101a24;--line:#2b3843}
  .team-page .public-container{width:min(100% - 44px,1320px);margin:0 auto}
  .team-hero{padding:86px 0 62px;background:radial-gradient(circle at 76% 20%,rgba(214,31,38,.13),transparent 30%),linear-gradient(135deg,#07101a,#0d1823)}
  .team-hero span{display:block;margin-bottom:14px;color:var(--gold-light);font-size:12px;font-weight:900;letter-spacing:.2em}
  ...
  .team-group-head span{display:block;margin-bottom:7px;color:var(--gold-light);font-size:12px;font-weight:900;letter-spacing:.18em}.team-group-head h2{margin:0;font:500 clamp(28px,3vw,38px)/1.05 Georgia,"Times New Roman",serif}.team-group-head p{max-width:430px;margin:0;color:#8d99a3;font-size:12px;line-height:1.7;text-align:right}
