...
const BOOK_TYPES=["Architectural & Structural Design Book","A4 Site Book","3D Design Book","Electrical Design Book","Plumbing Design Book","Soil Test Book","Municipality Approval Sheet"];
