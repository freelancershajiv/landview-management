...
export default function CertificatesPage() {
  ...
  return <div className="cert-page">
    <style>{`
      .cert-page{display:grid;gap:20px;color:#eee}.cert-hero small,.cert-head small{color:#ef6e64;font-size:8px;font-weight:900;letter-spacing:.13em}.cert-hero h1{font-size:34px;margin:7px 0 4px}.cert-hero p{margin:0;color:#858b91;font-size:11px}.cert-stats{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}.cert-stat,.cert-panel,.cert-registry{border:1px solid #34373b;background:#1b1d1f;border-radius:12px}.cert-stat{padding:15px}.cert-stat span{color:#7d848b;font-size:8px;font-weight:900}.cert-stat strong{display:block;font-size:24px;margin-top:7px}.cert-layout{display:grid;grid-template-columns:minmax(0,1fr) 330px;gap:16px}.cert-head{padding:17px 19px;border-bottom:1px solid #303438}.cert-head h2{font-size:17px;margin:6px 0 0}.cert-tabs{display:grid;grid-template-columns:repeat(3,1fr);gap:7px;padding:14px 18px 0}.cert-tabs button,.cert-actions button,.cert-actions a,.cert-toolbar button{border:1px solid #3a3f44;background:#151719;color:#ddd;border-radius:7px;cursor:pointer;text-decoration:none}.cert-tabs button{height:48px;font-size:9px;font-weight:900}.cert-tabs button.active{border-color:#ef493b;background:rgba(239,73,59,.1);color:white}.cert-form{padding:18px}.cert-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px}.cert-field{display:grid;gap:6px}.cert-field.full{grid-column:1/-1}.cert-field span{color:#8b9298;font-size:8px;font-weight:900;letter-spacing:.08em}.cert-field input,.cert-field select,.cert-field textarea,.cert-search{width:100%;border:1px solid #383c40;border-radius:8px;background:#101214;color:#eee;outline:none;padding:0 11px}.cert-field input,.cert-field select{height:43px}.cert-field textarea{min-height:92px;padding-top:10px}.cert-submit{height:48px;width:100%;border:0;border-radius:8px;background:#ef493b;color:#fff;font-size:9px;font-weight:900;margin-top:15px;cursor:pointer}.cert-submit:disabled{opacity:.55}.cert-alert{margin-bottom:12px;padding:10px;border-radius:8px;background:#321c19;color:#f1aaa2;font-size:10px}.cert-reissue{margin-bottom:12px;padding:11px;border:1px solid #645127;border-radius:8px;background:#221f17;color:#dfc67c;font-size:10px}.cert-help{padding:18px}.cert-help article{padding:12px 0;border-bottom:1px solid #303337}.cert-help strong{font-size:10px}.cert-help p{font-size:9px;color:#838a90;line-height:1.55;margin:5px 0 0}.cert-toolbar{display:flex;justify-content:space-between;gap:12px;align-items:center;padding:14px 16px;border-bottom:1px solid #303438}.cert-search{height:40px;max-width:360px}.cert-toolbar button{height:39px;padding:0 13px;font-size:8px;font-weight:900}.cert-table-wrap{overflow:auto}.cert-table{width:100%;border-collapse:collapse;min-width:900px}.cert-table th,.cert-table td{padding:11px 13px;text-align:left;border-bottom:1px solid #2e3236;font-size:9px}.cert-table th{color:#777f86;font-size:8px}.cert-status{display:inline-flex;padding:5px 7px;border-radius:999px;font-size:7px;font-weight:900;background:#233026;color:#9dd2ab}.cert-status.superseded{background:#332d1c;color:#dcc276}.cert-status.revoked,.cert-status.deleted{background:#3b211e;color:#ee9e94}.cert-actions{display:flex;gap:5px;flex-wrap:wrap}.cert-actions button,.cert-actions a{padding:6px 8px;font-size:7px;font-weight:900}.cert-actions .danger{border-color:#5c302a;color:#ef998f}.cert-actions button:disabled{opacity:.4;cursor:not-allowed}.certificate-wrap{scroll-margin-top:120px}.certificate-actions{display:flex;justify-content:flex-end;gap:8px;margin-bottom:10px}.certificate-actions a,.certificate-actions button{height:38px;padding:0 13px;border:1px solid #3a3e42;border-radius:7px;background:#202326;color:#ddd;text-decoration:none;display:inline-flex;align-items:center;font-size:8px;font-weight:900}.certificate-paper{width:min(100%,980px);aspect-ratio:1.414/1;margin:auto;background:#fff;color:#111;padding:44px 52px;position:relative;outline:2px solid #111;outline-offset:-21px}.certificate-top{display:flex;justify-content:space-between}.certificate-brand{display:flex;align-items:center;gap:11px}.certificate-brand img{width:60px}.certificate-brand strong{display:block;font-size:20px;letter-spacing:.1em}.certificate-brand span,.certificate-id span{display:block;color:#666;font-size:8px}.certificate-id{text-align:right}.certificate-id strong{font-size:10px}.certificate-title{text-align:center;margin-top:27px}.certificate-title small{color:#b52d24;font-size:9px;font-weight:900}.certificate-title h2{font:500 34px Georgia,serif;margin:7px 0}.certificate-body{text-align:center;max-width:740px;margin:22px auto}.certificate-name{font:500 28px Georgia,serif;margin:8px}.certificate-body p{font-size:10px;line-height:1.7}.certificate-subject{margin:16px auto;padding:9px;border-block:1px solid #ddd;font-size:11px;font-weight:800}.certificate-bottom{position:absolute;left:52px;right:52px;bottom:43px;display:grid;grid-template-columns:1fr auto 1fr;gap:25px;align-items:end}.certificate-bottom>div:not(.certificate-qr){border-top:1px solid #222;padding-top:7px;text-align:center;font-size:8px}.certificate-qr img{width:80px;height:80px}.certificate-qr{font-size:6px;text-align:center}.cert-empty{padding:24px;text-align:center;color:#7f868c;font-size:10px}@media(max-width:950px){.cert-layout{grid-template-columns:1fr}.cert-stats{grid-template-columns:1fr 1fr}}@media(max-width:620px){.cert-grid{grid-template-columns:1fr}.cert-field.full{grid-column:auto}.cert-tabs{grid-template-columns:1fr}.certificate-paper{min-height:680px;aspect-ratio:auto;padding:34px}.certificate-bottom{left:34px;right:34px}}@media print{body *{visibility:hidden!important}.certificate-paper,.certificate-paper *{visibility:visible!important}.certificate-paper{position:absolute;inset:0;width:100%;height:100%;box-shadow:none}.certificate-actions{display:none!important}@page{size:A4 landscape;margin:0}}
    `}</style>
