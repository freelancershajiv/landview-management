...
function PublicTeamSection() {
  ...
  return (
    <section className="public-section public-team" id="team"><div className="public-container">
      <div className="public-section-head"><div><span className="public-section-kicker">OUR TEAM</span><h2>The people behind LAND VIEW.</h2></div><p>Architects and engineers working together across design, technical coordination and project delivery.</p></div>
...
const services = [
  { number: "01", title: "Architectural Design", text: "Planning, space design and architectural drawing packages shaped around the site, brief and construction reality.", icon: "⌂" },
  { number: "02", title: "Structural Engineering", text: "Practical structural analysis and design for safe, efficient reinforced-concrete building systems.", icon: "▦" },
  { number: "03", title: "Planning & Approval", text: "Coordinated drawings, planning support and documentation prepared for a clearer approval and construction process.", icon: "◇" },
  { number: "04", title: "Site Supervision", text: "Site visits, technical observations and construction guidance that help the approved design reach the field correctly.", icon: "⌁" },
  { number: "05", title: "Interior & Renovation", text: "Functional interior planning and renovation solutions that improve existing spaces without losing engineering discipline.", icon: "◫" },
  { number: "06", title: "Engineering Consultancy", text: "Project-specific architectural and engineering advice for design decisions, feasibility and technical coordination.", icon: "＋" },
];
  ...
  return (
    <main className="public-site" id="home">
      ...
      <section className="public-hero"><div className="public-hero-grid" /><div className="public-hero-orbit public-hero-orbit-one" /><div className="public-hero-orbit public-hero-orbit-two" /><div className="public-container public-hero-inner">
        <div className="public-hero-copy"><span className="public-overline">ARCHITECTS & ENGINEERS</span><div className="public-hero-tag">DESIGNED TO DELIVER</div><h1>Architecture that works.<span> Engineering that lasts.</span></h1><p>LAND VIEW brings architectural design, structural engineering, planning and site supervision into one coordinated consultancy.</p><div className="public-hero-actions"><a href="#services" className="public-btn public-btn-accent">Explore Services <span>→</span></a><a href="#contact" className="public-btn public-btn-outline">Start a Project</a></div></div>
        <aside className="public-hero-panel"><span className="public-panel-kicker">LAND VIEW</span><strong>One team.</strong><strong>One workflow.</strong><small>Architecture • Structure • Supervision</small><div className="public-panel-rule" /><p>From the first sketch to technical delivery, every stage is coordinated around buildability and clear communication.</p></aside>
      </div></section>
      <section className="public-quick-band" aria-label="LAND VIEW services overview"><div className="public-quick-label"><span className="public-quick-ring">LV</span><div><small>DISCOVER</small><strong>What we do</strong></div></div><div className="public-quick-links"><a href="#services">Architecture</a><a href="#services">Structure</a><a href="#services">Planning</a><a href="#services">Supervision</a><a href="#contact" className="dark">Get Consultation</a></div></section>
      <section className="public-section public-services" id="services"><div className="public-container"><div className="public-section-head"><div><span className="public-section-kicker">OUR CAPABILITIES</span><h2>Design and engineering under one roof.</h2></div><p>A coordinated service model reduces gaps between architectural intent, structural decisions and site execution.</p></div><div className="public-service-grid">{services.map((service) => <article className="public-service-card" key={service.number}><div className="public-service-top"><span>{service.number}</span><b>{service.icon}</b></div><h3>{service.title}</h3><p>{service.text}</p><a href="#contact">Discuss your project <span>→</span></a></article>)}</div></div></section>
      <section className="public-about" id="about"><div className="public-about-technical" /><div className="public-container public-about-grid"><div className="public-about-copy"><span className="public-section-kicker light">ABOUT LAND VIEW</span><h2>Built around clear thinking and practical delivery.</h2><p>LAND VIEW Architects & Engineers approaches each project as one coordinated design problem—not separate architectural, structural and construction tasks.</p><p>The result is a more direct path from concept to drawings to site, with technical decisions considered early and communicated clearly.</p><a href="#contact" className="public-text-link">Work with LAND VIEW <span>→</span></a></div><div className="public-about-card"><span>OUR APPROACH</span><div className="public-about-row"><b>01</b><div><strong>Integrated</strong><small>Architecture and engineering coordinated together.</small></div></div><div className="public-about-row"><b>02</b><div><strong>Practical</strong><small>Solutions shaped for real construction conditions.</small></div></div><div className="public-about-row"><b>03</b><div><strong>Accountable</strong><small>Clear documentation and project follow-through.</small></div></div></div></div></section>
      <PublicTeamSection />
