...
const themeCss = `
  ...
  .public-theme-toggle:hover {
    ...
    border-color: var(--public-accent, #C63C3C);
    background: #303030;
  }
  .public-theme-toggle-icon { font-size: 17px; line-height: 1; }
  ...
  html[data-public-theme="dark"] .public-section { background-color: #111315; color: #f1f2ef; }
  html[data-public-theme="dark"] .public-service-grid,
  html[data-public-theme="dark"] .public-project-grid,
  html[data-public-theme="dark"] .public-team-grid { border-color: #34383b; }
  ...
  html[data-public-theme="dark"] .public-about-card {
    border-color: #34383b; background: #1b1e21; color: #f1f2ef; box-shadow: none;
  }
  ...
  html[data-public-theme="dark"] .public-team-card:hover {
    border-color: #50565a; box-shadow: 0 18px 42px rgba(0,0,0,.28);
  }
  ...
  html[data-public-theme="dark"] .public-team-card-bottom { border-color: #34383b; }
  ...
  html[data-public-theme="dark"] .public-about-row small { color: #a8adb0; }
  html[data-public-theme="dark"] .public-about-card,
  ...
  html[data-public-theme="dark"] .public-service-card h3 { color: #f1f2ef; }
  html[data-public-theme="dark"] .public-quick-links a:not(.dark) { background: #f0f1ee; color: #34383b; }
  html[data-public-theme="dark"] .public-nav-wrap { background: #17191b; }
  html[data-public-theme="dark"] .public-nav a:hover { background: #22262a; }
  html[data-public-theme="dark"] .public-menu-button,
  html[data-public-theme="dark"] .public-theme-toggle { background: #111315; border-color: #3d4246; }
  @media (max-width: 860px) {
    .public-theme-toggle { margin-left: auto; margin-right: 8px; }
  }
`;
      ...
      <header className="public-header">
        <div className="public-utility">
          <div className="public-container public-utility-inner">
            ...
            <a href="https://app.landview.com.bd" className="public-employee-link">Client / Staff Portal <span>→</span></a>
          </div>
        </div>
        <div className="public-nav-wrap">
          <div className="public-container public-nav-inner">
            ...
            <button type="button" className="public-theme-toggle" aria-label={theme === "dark" ? "Switch to normal mode" : "Switch to dark mode"} title={theme === "dark" ? "Normal mode" : "Dark mode"} onClick={toggleTheme}>
              <span className="public-theme-toggle-icon" aria-hidden="true">{theme === "dark" ? "☀" : "☾"}</span>
            </button>
            <button type="button" className="public-menu-button" aria-label="Toggle website navigation" aria-expanded={open} onClick={() => setOpen((value) => !value)}>
              <span /><span /><span />
            </button>
          </div>
        </div>
