    ...
    <section className="lv-hero" id="home">
      ...
      <div className="public-container lv-hero-grid">
        <div className="lv-hero-copy">
          ...
          <h1>ENGINEERING &amp;<br /><em>ARCHITECTURE.</em></h1>
          <div className="lv-gold-rule" />
          <p>Engineering and architectural consultancy in Bangladesh, based in Feni. LAND VIEW coordinates building planning, structural design and site supervision for residential and commercial projects.</p>
...
const homeCss = `
  ...
  .lv-hero { position: relative; padding: 0 0 34px; overflow: hidden; background: radial-gradient(circle at 78% 30%, rgba(214,31,38,.12), transparent 30%), linear-gradient(115deg,#07111b,#0b1620 48%,#050a0f); }
  ...
  .lv-eyebrow { display: block; margin-bottom: 20px; color: #9aa5ae; font-size:12px; font-weight: 900; letter-spacing: .22em; }
  ...
  .lv-btn { min-height: 48px; display: inline-flex; align-items: center; justify-content: center; padding: 0 24px; border-radius: 6px; font-size:12px; font-weight: 900; letter-spacing: .05em; text-transform: uppercase; transition: .18s ease; }
  .lv-btn:hover { transform: translateY(-2px); }
  .lv-btn-gold { border: 1px solid var(--lv-gold-light); background: linear-gradient(180deg,#d61f26,#ad171d); color: #fff; box-shadow: 0 10px 25px rgba(0,0,0,.23); }
  .lv-btn-outline { border: 1px solid rgba(214,31,38,.78); background: rgba(3,9,14,.18); color: #fff; }
  ...
  .lv-building { position:absolute; right:8%; bottom:4%; width:72%; height:78%; border:1px solid rgba(255,255,255,.18); transform:perspective(700px) rotateY(-8deg); background:linear-gradient(90deg,rgba(214,31,38,.08),transparent 2%),linear-gradient(120deg,#1d2b36,#0d161e); box-shadow:0 25px 50px rgba(0,0,0,.4); }
  ...
  .lv-building span { position:absolute; width:26%; height:3px; background:var(--lv-gold); box-shadow:0 0 18px rgba(214,31,38,.8); }
  ...
  .lv-building-glow { position:absolute; right:14%; bottom:7%; width:60%; height:24%; background:radial-gradient(ellipse,rgba(214,31,38,.2),transparent 65%); filter:blur(8px); }
  ...
  .lv-project-badge small,.lv-project-badge strong,.lv-project-badge span{display:block}.lv-project-badge small{color:var(--lv-gold-light);font-size:12px;font-weight:900;letter-spacing:.15em}.lv-project-badge strong{margin-top:6px;font:500 17px/1.15 Georgia,"Times New Roman",serif}.lv-project-badge span{margin-top:5px;color:#8d98a2;font-size:12px;letter-spacing:.08em}
  ...
  .lv-hero-services article:last-child{border-right:0}.lv-hero-services b{width:44px;flex:0 0 44px;color:var(--lv-gold-light);font-size:28px;text-align:center}.lv-hero-services strong,.lv-hero-services span{display:block}.lv-hero-services strong{font-size:12px;text-transform:uppercase;letter-spacing:.03em}.lv-hero-services span{margin-top:7px;color:#c3c9cf;font-size:12px;line-height:1.5}
  .lv-section { padding:92px 0; background:#0a121b; color:#fff; }
  .lv-section:nth-of-type(even){background:#0d1721}.lv-section-head{display:flex;align-items:flex-end;justify-content:space-between;gap:50px;margin-bottom:40px}.lv-section-head>div{max-width:720px}.lv-section-head>div>span{display:block;margin-bottom:12px;color:var(--lv-gold-light);font-size:12px;font-weight:900;letter-spacing:.2em}.lv-section-head h2{margin:0;font:500 clamp(34px,4vw,54px)/1 Georgia,"Times New Roman",serif;letter-spacing:-.025em}.lv-section-head>p{max-width:400px;margin:0;color:#9ba5ae;font-size:12px;line-height:1.75}
  .lv-services-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));border-top:1px solid var(--lv-line);border-left:1px solid var(--lv-line)}.lv-service-card{position:relative;min-height:260px;padding:24px;border-right:1px solid var(--lv-line);border-bottom:1px solid var(--lv-line);background:#101b25;transition:.2s ease}.lv-service-card:hover{z-index:2;transform:translateY(-4px);background:#142330;box-shadow:0 18px 36px rgba(0,0,0,.25)}.lv-service-top{display:flex;align-items:center;justify-content:space-between}.lv-service-top span{color:#667482;font-size:12px;font-weight:900}.lv-service-top b{width:40px;height:40px;display:grid;place-items:center;border:1px solid #33404b;color:var(--lv-gold-light);font-size:18px}.lv-service-card h3{margin:38px 0 0;font:500 20px/1.12 Georgia,"Times New Roman",serif}.lv-service-card p{margin:14px 0 0;color:#96a2ac;font-size:12px;line-height:1.72}.lv-service-card a{position:absolute;left:24px;bottom:22px;color:var(--lv-gold-light);font-size:12px;font-weight:900;letter-spacing:.06em;text-transform:uppercase}
  .lv-about{position:relative;overflow:hidden;padding:100px 0;background:linear-gradient(120deg,#07101a,#111d28);color:#fff}.lv-about::after{content:"";position:absolute;inset:0;opacity:.18;background-image:linear-gradient(rgba(255,255,255,.05) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.05) 1px,transparent 1px);background-size:58px 58px}.lv-about-grid{position:relative;z-index:2;display:grid;grid-template-columns:1.15fr .85fr;gap:70px;align-items:center}.lv-about-copy>span{color:var(--lv-gold-light);font-size:12px;font-weight:900;letter-spacing:.2em}.lv-about-copy h2{margin:14px 0 0;font:500 clamp(36px,4.4vw,58px)/1 Georgia,"Times New Roman",serif}.lv-about-copy p{max-width:650px;margin:20px 0 0;color:#abb5be;font-size:12px;line-height:1.82}.lv-about-card{padding:28px;border:1px solid rgba(214,31,38,.35);border-top:5px solid var(--lv-gold);background:#0c1721;box-shadow:0 20px 42px rgba(0,0,0,.3)}.lv-about-card>span{display:block;margin-bottom:8px;color:var(--lv-gold-light);font-size:12px;font-weight:900;letter-spacing:.14em}.lv-about-row{display:grid;grid-template-columns:42px 1fr;gap:14px;padding:19px 0;border-top:1px solid var(--lv-line)}.lv-about-row>b{color:#596773;font-size:12px}.lv-about-row strong,.lv-about-row small{display:block}.lv-about-row strong{font:500 18px Georgia,"Times New Roman",serif}.lv-about-row small{margin-top:7px;color:#8f9ba5;font-size:12px;line-height:1.6}
  .lv-team-section{background:#0b141d}.lv-team-groups{display:grid;gap:58px}.lv-team-group{display:grid;gap:22px}.lv-team-group-head{display:flex;align-items:end;justify-content:space-between;gap:30px;padding-bottom:16px;border-bottom:1px solid #2b3843}.lv-team-group-head>div>span{display:block;margin-bottom:7px;color:var(--lv-gold-light);font-size:12px;font-weight:900;letter-spacing:.18em}.lv-team-group-head h3{margin:0;font:500 clamp(24px,3vw,34px)/1.05 Georgia,"Times New Roman",serif}.lv-team-group-head>p{max-width:390px;margin:0;color:#89959f;font-size:12px;line-height:1.65;text-align:right}.lv-team-group-empty{padding:24px;border:1px dashed #34414c;color:#77838c;font-size:12px;text-align:center}.lv-team-grid{display:flex!important;flex-wrap:wrap;justify-content:center;gap:18px!important}.lv-team-grid>.lv-team-card{flex:0 1 calc((100% - 54px)/4);max-width:calc((100% - 54px)/4);width:100%}.lv-team-card{border:1px solid #2b3843!important;background:#101a24!important;color:#fff!important;box-shadow:0 14px 34px rgba(0,0,0,.22)!important}.lv-team-card .public-team-designation,.lv-team-card .public-team-label{color:var(--lv-gold-light)!important}.lv-team-card .public-team-name,.lv-team-card .public-team-info-block strong,.lv-team-card .public-team-degree{color:#fff!important}.lv-team-card .public-team-specialities,.lv-team-card .public-team-specialities span{color:#99a5ae!important}.lv-team-card .public-team-info-block{border-color:#2b3843!important}.lv-team-card .public-team-photo{border-color:var(--lv-gold)!important}.lv-team-card .public-team-photo span{background:#07101a!important}.lv-empty{padding:38px;border:1px solid #2b3843;background:#101a24;color:#aab4bc;text-align:center}
  .lv-projects{background:#07101a}.lv-projects-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:18px}.lv-project-card{min-height:250px;display:flex;flex-direction:column;padding:26px;border:1px solid #2a3640;background:linear-gradient(145deg,#12202b,#0b141d);transition:.2s ease}.lv-project-card:hover{transform:translateY(-4px);border-color:#6d5624;box-shadow:0 18px 35px rgba(0,0,0,.24)}.lv-project-card>span{color:var(--lv-gold-light);font-size:12px;font-weight:900;letter-spacing:.15em}.lv-project-card h3{margin:48px 0 0;font:500 25px/1.1 Georgia,"Times New Roman",serif}.lv-project-card p{margin:13px 0 0;color:#94a1ab;font-size:12px;line-height:1.7}.lv-project-card a{margin-top:auto;padding-top:24px;color:var(--lv-gold-light);font-size:12px;font-weight:900;letter-spacing:.06em}
  .lv-process{background:#0d1721}.lv-process-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));border-top:1px solid #34414c;border-left:1px solid #34414c}.lv-process-grid article{min-height:210px;padding:26px;border-right:1px solid #34414c;border-bottom:1px solid #34414c;background:#101b25}.lv-process-grid span{color:var(--lv-gold-light);font-size:12px;font-weight:900}.lv-process-grid h3{margin:42px 0 0;font:500 23px Georgia,"Times New Roman",serif}.lv-process-grid p{margin:12px 0 0;color:#8f9ba5;font-size:12px;line-height:1.7}
  .lv-contact{padding:88px 0;background:linear-gradient(125deg,#101b25,#07101a);border-top:1px solid rgba(214,31,38,.25);color:#fff}.lv-contact-grid{display:grid;grid-template-columns:1fr .85fr;gap:70px;align-items:center}.lv-contact-copy>span{color:var(--lv-gold-light);font-size:12px;font-weight:900;letter-spacing:.2em}.lv-contact h2{margin:14px 0 0;font:500 clamp(35px,4vw,54px)/1 Georgia,"Times New Roman",serif}.lv-contact p{max-width:580px;margin:18px 0 26px;color:#9ba6af;font-size:12px;line-height:1.75}.lv-contact-card{padding:24px 28px;border:1px solid #34414c;background:#0b151e}.lv-contact-card>div{padding:16px 0;border-top:1px solid #2c3944}.lv-contact-card>div:first-child{border-top:0}.lv-contact-card span{display:block;margin-bottom:6px;color:var(--lv-gold-light);font-size:12px;font-weight:900;letter-spacing:.12em}.lv-contact-card strong,.lv-contact-card a{color:#fff;font-size:12px}.lv-contact-card p{margin:5px 0 0;font-size:12px}
  .lv-footer{padding:36px 0;border-top:1px solid #25313b;background:#050a0f;color:#fff}.lv-footer-grid{display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:30px}.lv-footer-brand{display:flex;align-items:center;gap:12px}.lv-footer-brand img{width:54px;height:54px}.lv-footer-brand strong,.lv-footer-brand span{display:block}.lv-footer-brand strong{font-family:Georgia,"Times New Roman",serif;font-size:15px;letter-spacing:.1em}.lv-footer-brand span{margin-top:5px;color:#77838c;font-size:6px;letter-spacing:.17em}.lv-footer-links{display:flex;gap:18px}.lv-footer-links a{color:#9ca6ae;font-size:12px;font-weight:800;text-transform:uppercase}.lv-footer-links a:hover{color:var(--lv-gold-light)}.lv-footer-copy{text-align:right}.lv-footer-copy span,.lv-footer-copy small{display:block}.lv-footer-copy span{font-size:12px;color:#9ca6ae}.lv-footer-copy small{margin-top:5px;color:#59656e;font-size:12px}
    ...
    <main className="public-site">
      ...
      <section className="lv-section" id="services">
        <div className="public-container">
          ...
          <div className="lv-services-grid">{publicServices.map(({slug,name,shortDescription,icon}, index) => <article className="lv-service-card" key={slug}><div className="lv-service-top"><span>{String(index + 1).padStart(2,"0")}</span><b>{icon}</b></div><h3>{name}</h3><p>{shortDescription}</p><Link href={`/services/${slug}`}>Explore {name.toLowerCase()} →</Link></article>)}</div>
        </div>
      </section>
      ...
      <footer className="lv-footer"><div className="public-container lv-footer-grid"><div className="lv-footer-brand"><img src="/land-view-logo.svg" alt="LAND VIEW" /><div><strong>LAND VIEW</strong><span>ENGINEERS &amp; ARCHITECTS</span></div></div><div className="lv-footer-links"><a href="#about">About</a><Link href="/services">Services</Link><Link href="/projects">Projects</Link><Link href="/team">Team</Link><Link href="/contact">Contact</Link></div><div className="lv-footer-copy"><span>© 2026 LAND VIEW</span><small>Designing Better. Building Safer.</small></div></div></footer>
    </main>
  );
}
