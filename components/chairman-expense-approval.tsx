...
export default function ChairmanExpenseApproval() {
  ...
  return <section className="chairman-approval" id="chairman-expense-approvals">
    ...
    `}</style>
    <div className="cap-head"><div><span className="cap-badge">EMP-0001 · CHAIRMAN APPROVAL</span><h2>Expense approval queue</h2></div><p>Office operating expenses remain separate from Eng. Rony personal/salary drawings. Approved personal drawings are LAND VIEW outflows, not office operating costs.</p></div>
