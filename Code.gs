...
function handleAction(
  ...
  switch (action) {
    ...
    case "getPublicBillingVerification": return getPublicBillingVerification(params);
...
const ERP_MODULES = {
  ...
  expenses: {
    ...
    headers: ["Expense_ID", "Project_ID", "Expense_Date", "Category", "Description", "Amount", "Payment_Method", "Reference", "Status", "Notes", "Reviewed_By", "Reviewed_At", "Review_Notes", "Created_At", "Created_By"]
  },
  quotations: {
...
function isMainAdminRole_(role) {
...
function ensurePermissionHeaders_() {
